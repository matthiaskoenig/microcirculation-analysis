...
def video_stabilization_pipeline(video_path: Path, detection_config: Iterable):
    vessels_video_path = generate_vessel_detected_video(video_path=video_path, detection_config=detection_config)
    stabilize_video(original_video_path=video_path, vessels_video_path=vessels_video_path)
...
if __name__ == "__main__":
    ...
    video_stabilization_pipeline(video_path=video_path, detection_config=detection_config)
